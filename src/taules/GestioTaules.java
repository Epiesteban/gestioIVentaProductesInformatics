...
public class GestioTaules extends DefaultTableCellRenderer{
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
		//Aquest metode controla tota la taula, podem obtenir el valor que cont�, definir quina casella esta seleccionada, i el color segons si la informacio es numerica o no
